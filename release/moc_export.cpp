...
QT_MOC_LITERAL(1, 7, 16), // "file_name_export"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "filename"
QT_MOC_LITERAL(4, 34, 21), // "on_toolButton_clicked"
QT_MOC_LITERAL(5, 56, 24) // "on_pushButton_Ok_clicked"

    },
    "Export\0file_name_export\0\0filename\0"
    "on_toolButton_clicked\0on_pushButton_Ok_clicked"
};
...
void Export::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->file_name_export((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Export::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Export::file_name_export)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Export::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Export.data,
      qt_meta_data_Export,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Export::file_name_export(QString _t1)
{
